                            ...
                            .then(function (options) {
                                ...
                                if ($scope.data) {
                                    var renderChart = function (amChartOptions) {
                                        ...
                                        if (o.type === 'xy') {
                                            chart = o.theme
                                                ? new AmCharts.AmXYChart(AmCharts.themes[o.theme])
                                                : new AmCharts.AmXYChart();
                                        } else if (o.type === 'pie') {
                                            chart = o.theme
                                                ? new AmCharts.AmPieChart(AmCharts.themes[o.theme])
                                                : new AmCharts.AmPieChart();
                                        } else if (o.type === 'funnel') {
                                            chart = o.theme
                                                ? new AmCharts.AmFunnelChart(AmCharts.themes[o.theme])
                                                : new AmCharts.AmFunnelChart();
                                        } else if (o.type === 'radar') {
                                            chart = o.theme
                                                ? new AmCharts.AmRadarChart(AmCharts.themes[o.theme])
                                                : new AmCharts.AmRadarChart();
                                        } else if (o.type === 'gauge') {
                                            chart = o.theme
                                                ? new AmCharts.AmAngularGauge(AmCharts.themes[o.theme])
                                                : new AmCharts.AmAngularGauge();
                                        } else {
                                            chart = o.theme
                                                ? new AmCharts.AmSerialChart(AmCharts.themes[o.theme])
                                                : new AmCharts.AmSerialChart();
                                        }
                                        ...
                                        $q.when($scope.data)
                                            .then(function (data) {
                                                ...
                                                if (o.type != 'gauge') {
                                                    chart
                                                        .categoryField =
                                                        o.categoryField || Object.keys($scope.data[0])[0];
                                                }
                                                ...
                                                function generateGraphProperties(data) {
                                                    ...
                                                    if (o.categoryAxis) {
                                                        ...
                                                        if (categoryAxis) {
                                                            ...
                                                            for (var i = 0; i < keys.length; i++) {
                                                                if (
                                                                    !angular.isObject(o.categoryAxis[keys[i]]) ||
                                                                        angular.isArray(o.categoryAxis[keys[i]])) {
                                                    ...
                                                    var addGraph = function (g) {
                                                        ...
                                                        if (g && $scope.data && $scope.data.length > 0) {
                                                            graph
                                                                .valueField =
                                                                g.valueField || Object.keys($scope.data[0])[1];
                                                        }
                                                        graph
                                                            .balloonText =
                                                    ...
                                                    for (var i = 0; i < obj.length; i++) {
                                                        if (obj[i].listeners) {
                                                            ...
                                                            for (var l = 0; l < listeners.length; l++) {
                                                                chartObj[i]
                                                                    .addListener(listeners[l].event, listeners[l].method);
                                                            }
                                                        }
                                                    }
                                                };
                                                ...
                                                for (var i = 0; i < chartKeys.length; i++) {
                                                    if (typeof o[chartKeys[i]] !== 'object' &&
                                                        typeof o[chartKeys[i]] !== 'function') {
                                    ...
                                    var onAmChartsTriggerChartAnimate = $scope.$on('amCharts.triggerChartAnimate',
                                        function (event, id) {
                                            if (id === $el[0].id || !id) {
                                                chart.animateAgain();
                                            }
                                    ...
                                    var onAmChartsUpdateData = $scope.$on('amCharts.updateData',
                                            ...
                                            if (id === $el[0].id || !id) {
                                                if ($scope.options.type == 'gauge') {
                                                    ...
                                                    for (var i = 0; i < data.length; i++) {
                                                        chart.arrows[i] &&
                                                            chart.arrows[i].setValue &&
                                                            chart.arrows[i].setValue(data[i]);
                                                    }
                                                } else {
                                                    chart.dataProvider = data;
                                                    chart.validateData();
                                    ...
                                    var onAmChartsValidateNow = $scope.$on('amCharts.validateNow',
                                        function (event, validateData, skipEvents, id) {
                                            if (id === $el[0].id || !id) {
                                    ...
                                    var onAmChartsRenderChart = $scope.$on('amCharts.renderChart',
                                        function (event, amChartOptions, id) {
