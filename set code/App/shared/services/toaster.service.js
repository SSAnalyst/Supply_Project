    ...
    angular.module("app.addons")
        ...
        */
        .service('toaster', ['$rootScope', function ($rootScope) {
            ...
            t.pop = function (type, title, body, timeout, bodyOutputType) {
                this.toast = {
                    type: type,
                    title: title,
                    body: body,
            ...
            return {
                ...
                link: function (scope, elm, attrs) {
                    ...
                    function addToast(toast) {
                        ...
                        if (!toast.type) toast.type = mergedConfig['icon-class'];
                ...
                '<div  id="toast-container" ng-class="config.position">' +
                    '<div ng-repeat="toaster in toasters" class="toast clearfix" ng-class="toaster.type" ng-click="remove(toaster.id)" ng-mouseover="stopTimer(toaster)">' +
                        '<div class="toaster-left"></div>' +
                        '<div class="toaster-right">'+
